...
echo "<h3><table cellspacing='0'>";
 ...
 // NOTE ECHO ALL CHALLENGES SORTED BY IF THEIR COMPLETED OR NOT
   ...
   if ($hidden == 0) {
   if ($challenge['is_completed'] === true AND $replay == 0) { echo"<tr class='filterDiv completed $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}

elseif ($challenge['is_completed'] === true AND $replay == 1) { echo"<tr data-href='./challenge/challenge.php?challenge_id=" . $challenge['challenge_id'] . "' class='filterDiv challenge-row notcompleted $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}


else { echo"<tr data-href='./challenge/challenge.php?challenge_id=" . $challenge['challenge_id'] . "' class='new filterDiv challenge-row notcompleted $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}
...
if ($hidden == 0) {
if ($challenge['is_completed'] === true AND $replay == 1) { echo"<tr data-href='./challenge/challenge.php?challenge_id=" . $challenge['challenge_id'] . "' class='filterDiv challenge-row notcompleted $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}


elseif ($challenge['is_completed'] === false)  { echo"<tr data-href='./challenge/challenge.php?challenge_id=" . $challenge['challenge_id'] . "' class='new filterDiv challenge-row notcompleted $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}
 } else {} // IF HIDDEN IS 1
}
 echo "</table></h3>"; //Close the table in HTML
 echo "</div>";
 ...
 ?>
  ...
  <div class="tab-pane" id="third"> <!-- new -->
    <div class="namedesig">
    <?php
...
if ($hidden == 0) {
if ($challenge['is_completed'] === false) { echo"<tr data-href='./challenge/challenge.php?challenge_id=" . $challenge['challenge_id'] . "' class='new filterDiv challenge-row notcompleted $category'><td>" . $challenge['name'] . "</td><td>" . $challenge['part_points'] . "</td></tr>";}
 } else {} // IF HIDDEN IS 1
}
echo "</table></h3>"; //Close the table in HTML
echo "</div>";
 ?>
  ...
  <div class="tab-pane" id="fourth"> <!-- completed -->
    <div class="namedesig">
    <?php
